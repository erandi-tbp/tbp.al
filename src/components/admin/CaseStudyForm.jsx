...
export const CaseStudyForm = ({ initialData, onSubmit, submitLabel = 'Save' }) => {
  const [formData, setFormData] = useState({
    ...
    projectId: initialData?.projectId || '', // Will be stored in meta
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., How We Increased Traffic by 300%"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., increased-traffic-300-percent"
                />
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-text-secondary font-body mt-1">
                  Categorize this case study under a service group
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={6}
                  className="w-full px-4 py-2 bg-bg-primary border border-border rounded-lg text-text-primary placeholder:text-text-secondary font-body font-mono text-sm focus:outline-none focus:border-accent resize-none"
                  placeholder='{"sections": [], "stats": {}}'
                />
                <p className="mt-1 text-xs text-text-secondary font-body">
                  Custom data for case study template
                </p>
              </div>
